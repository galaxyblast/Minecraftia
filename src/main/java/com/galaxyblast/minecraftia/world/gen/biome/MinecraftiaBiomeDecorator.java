...
public class MinecraftiaBiomeDecorator extends BiomeDecorator
{
    public World currentWorld;
    public Random randomGenerator;
    public int chunk_X;
    public int chunk_Z;
    public WorldGenerator clayGen = new ClayGen();;
    ...
    public boolean genForest;
    public TreeGen treeGenerator;

    public MinecraftiaBiomeDecorator()
    {
        this.sandGen = new SandGen();
        this.gravelAsSandGen = new SandGen();
        ...
        this.grassPerChunk = 16;
        this.sandPerChunk = 24;
        this.sandPerChunk2 = 24;
        this.clayPerChunk = 1;
