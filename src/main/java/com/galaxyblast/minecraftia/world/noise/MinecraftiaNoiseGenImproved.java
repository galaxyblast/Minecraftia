...
public class MinecraftiaNoiseGenImproved extends NoiseGeneratorImproved
{
    ...
    public MinecraftiaNoiseGenImproved()
    {
        this(new Random());
    }

    public MinecraftiaNoiseGenImproved(Random p_i45469_1_)
    {
        ...
        if (p_76308_9_ == 1)
        {
            ...
            for (int j1 = 0; j1 < p_76308_8_; ++j1)
            {
                ...
                for (l1 = 0; l1 < p_76308_10_; ++l1)
                {
                    ...
                    d21 = this.lerp(d11, this.func_76309_a(this.permutations[i4], d9, d12), this.grad2(this.permutations[i1], d9 - 1.0D, 0.0D, d12));
                    d22 = this.lerp(d11, this.grad2(this.permutations[i4 + 1], d9, 0.0D, d12 - 1.0D), this.grad2(this.permutations[i1 + 1], d9 - 1.0D, 0.0D, d12 - 1.0D));
                ...
                for (int k2 = 0; k2 < p_76308_10_; ++k2)
                {
                    ...
                    for (int j3 = 0; j3 < p_76308_9_; ++j3)
                    {
                        ...
                        if (j3 == 0 || l3 != i1)
                        {
                            ...
                            d8 = this.lerp(d13, this.grad2(this.permutations[l4], d12, d16, d14), this.grad2(this.permutations[k5], d12 - 1.0D, d16, d14));
                            d9 = this.lerp(d13, this.grad2(this.permutations[i5], d12, d16 - 1.0D, d14), this.grad2(this.permutations[l5], d12 - 1.0D, d16 - 1.0D, d14));
                            d10 = this.lerp(d13, this.grad2(this.permutations[l4 + 1], d12, d16, d14 - 1.0D), this.grad2(this.permutations[k5 + 1], d12 - 1.0D, d16, d14 - 1.0D));
                            d11 = this.lerp(d13, this.grad2(this.permutations[i5 + 1], d12, d16 - 1.0D, d14 - 1.0D), this.grad2(this.permutations[l5 + 1], d12 - 1.0D, d16 - 1.0D, d14 - 1.0D));
                        }
    ...
    public final double grad2(int p_76310_1_, double p_76310_2_, double p_76310_4_, double p_76310_6_)
    {
        int j = p_76310_1_ & 15;
        double scale = 0.6D;
        return (field_152381_e[j] * p_76310_2_ + field_152382_f[j] * p_76310_4_ + field_152383_g[j] * p_76310_6_) * scale;
    }
}
